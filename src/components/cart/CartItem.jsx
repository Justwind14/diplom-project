...
const CartItem = (props) => {
    ...
    return (
        <div className="card-min">
            <div>
                <img className="card-min__img" alt="fashionable man" src={require("../../img/" + props.good.imgName)}/>
            </div>
            <div className="card-min__desc">
                <div className="card-min__top">
                    <Link to="/product" className="card-min__title">{props.good.title}</Link>
                    <Buttons style={{appearance: 'none'}} onClick={handleClick} className="svg-button">
                ...
                <p className="card-min__text">Price: <span className="accent_text">
                    ${props.good.price * props.good.quantity}</span></p>
                <p className="card-min__text">Color: {props.good.color}</p>
                <p className="card-min__text">Size: {props.good.size}</p>
