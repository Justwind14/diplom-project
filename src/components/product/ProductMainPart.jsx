...
const ProductMainPart = ({onSizeChange, onPriceRangeChange, onColorChange, currentSlide, sliderRef}) => {
    const addToCart = useAddToCart();

    const handleClick = (e) => {
        e.preventDefault();
        addToCart(currentSlide);
    ...
    return (
        <div className="center">
            <section className="product-desc center">
                <ProductDescription currentSlide={currentSlide}/>
                <div className="product__down">
                    <form className="choose-form" action="#">
                        ...
                        <Buttons className="choose__button" onClick={handleClick}>
